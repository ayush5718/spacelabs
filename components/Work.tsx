...
export default function Work() {
  useEffect(() => {
    ...
    // Image Parallax with enhanced effect
    document.querySelectorAll('.parallax-container').forEach((container, index) => {
      ...
      if (img) {
        ...
        gsap.from(container.closest('.tilt-card'), {
          opacity: 0,
          y: 80,
          scale: 0.8,
          rotationY: -20,
          ...
          ease: "power3.out",
          scrollTrigger: {
            trigger: container.closest('.tilt-card'),
            start: "top 85%",
            toggleActions: "play none none reverse"
          }
        });
    ...
    // 3D Card Tilt + Spotlight + Liquid Hover
  ...
  return (
    <section id="work" className="px-4 md:px-10 py-40 bg-boulder-black relative z-10" data-theme="dark">
      <div className="max-w-[1920px] mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-32 border-b border-white/20 pb-10">
          <h2 className="work-title text-5xl md:text-8xl font-bold uppercase tracking-tighter max-w-3xl leading-[0.9] split-heading">
          ...
          <a href="#" className="magnetic hover-trigger mt-8 md:mt-0 font-mono text-xs uppercase border border-white/30 px-10 py-5 hover:bg-white hover:text-black transition-all tracking-widest rounded-full">
            View All Work
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-40">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="parallax-container w-full aspect-[4/3] bg-neutral-900 relative mb-8 overflow-hidden rounded-sm">
                <div 
                ...
                <div className="tilt-content absolute inset-0 flex items-center justify-center pointer-events-none">
                  <div className="overlay-text text-[8vw] font-bold tracking-tighter text-white mix-blend-overlay opacity-50 group-hover:opacity-100 transition-opacity">
                    {project.overlayText}
                  </div>
                </div>
              </div>
              <div className="flex justify-between items-start border-t border-white/20 pt-6 tilt-content relative z-10">
                <div className="project-info">
                  <h3 className="text-3xl font-bold uppercase mb-2 group-hover:text-gray-300 transition-colors">
                ...
                <span className="project-arrow text-3xl group-hover:-translate-y-2 group-hover:translate-x-2 transition-transform duration-500 text-gray-500 group-hover:text-white">
